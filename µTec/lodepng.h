...
typedef struct LodePNGInfo
{
  ...
  */
  ...
  text_strings, while text_keys are keywords that give a int description what
...
unsigned int* buffer on x86 CPUs.
...
*) 03 mar 2007: Made it encode dynamic Huffman inter with repeat codes.
